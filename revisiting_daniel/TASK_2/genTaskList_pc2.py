...
for dataName in dataFileList:
    if dataName not in ["posLen_tp_1_v1","posAngle_bar_v1","posLen_tp_mix_rand","posLen_tp_mix","pointCloud_10","pointCloud_100","pointCloud_1000"]:
        continue
    cmd = dataCommandTemplate % dataName
    dataTask=None
    dataTask = TaskInfo(cmd,{"disk":40,"gpu":0},[],False,999)
