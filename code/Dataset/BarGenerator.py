...
class BarGenerator(VisAbstractGen.VisAbstractGen):
    ...
    def gen(self, index, isTrainData=True):
        ...
        '''
        #train
        # Combination_all=getCombination()
        # Combination=Combination_all[index%len(Combination_all)]
        # tick_number=Combination[0]
        # ymax_value=Combination[1]
        # spacePaddingLeft=Combination[2][0]
        # spacePaddingRight=Combination[2][1]
        # midGap=Combination[2][2]
        # barWidth=Combination[2][3]

        # isrotate=Combination[3]
        # TitlePosition='mid'
        # Axislabel='both'

        #test方案一
        # Combination_all=getTestCombination()
        # Combination=Combination_all[index%len(Combination_all)]
        # tick_number=Combination[0]
        # Axislabel=Combination[1]
        # ymax_value=Combination[2]
        # TitlePosition=Combination[3]
        # spacePaddingLeft=Combination[4][0]
        # spacePaddingRight=Combination[4][1]
        # midGap=Combination[4][2]
        # barWidth=Combination[4][3]

        # if Combination[5]=='Horizontal':
        #     isrotate=True
        # else:
        #     isrotate=False
